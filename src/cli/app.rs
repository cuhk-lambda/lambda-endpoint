...
fn get_matches<'a>() -> ArgMatches<'a> {
    ...
    App::new("lambda-endpoint")
        .subcommand(SubCommand::with_name("endpoint").help("start endpoint")
            .arg(Arg::with_name("config").short("c").long("config").value_name("CONFIG")
                .help("path to the configuration").required(true)))
        .subcommand(SubCommand::with_name("add").help("add trace")
            .arg(Arg::with_name("config").short("c").long("config").value_name("CONFIG")
                .help("path to the configuration").required(true))
        ...
        .subcommand(SubCommand::with_name("delete").help("delete trace")
            .arg(Arg::with_name("config").short("c").long("config").value_name("CONFIG")
                .help("path to the configuration").required(true))
            .arg(Arg::with_name("id").short("i").long("i").value_name("ID")
                .help("id of the trace to be deleted").required(true).multiple(true)))
        .subcommand(SubCommand::with_name("get").help("get trace")
            .arg(Arg::with_name("config").short("c").long("config").value_name("CONFIG")
                .help("path to the configuration").required(true))
            .arg(Arg::with_name("id").short("i").long("i").value_name("ID")
                .help("id of the trace to be got").required(true)))
        .subcommand(SubCommand::with_name("list").help("list add traces")
            .arg(Arg::with_name("config").short("c").long("config").value_name("CONFIG")
                .help("path to the configuration").required(true)))
        .subcommand(SubCommand::with_name("run").help("run the given trace")
            .arg(Arg::with_name("config").short("c").long("config").value_name("CONFIG")
                .help("path to the configuration").required(true))
            .arg(Arg::with_name("id").short("i").long("i").value_name("ID")
                .help("id of the trace to be got").required(true))
